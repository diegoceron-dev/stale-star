...
<template>
  <div>
    <div class="flex items-center justify-between content-center py-4 px-12">
      <div class="space-y-1">
    ...
    <div class="space-y-1">
      <h3
        class="flex items-center justify-between content-center py-4 px-12 text-1xl font-semibold tracking-tight"
      >
