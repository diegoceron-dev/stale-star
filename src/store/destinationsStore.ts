...
interface DestinationsStore {
  allInclusive: Array<CoverType>;
  europeanPlan: Array<CoverType>;
  allResorts: Array<any>;
}

const allInclusive: CoverType[] = [
  {
    id: "1",
    cover:
...
const allResorts = [
  { brandId: 'palace_resorts', brand: "All Inclusive", items: allInclusive },
  { brandId: 'baglioni', brand: "European Plan", items: europeanPlan },
];
